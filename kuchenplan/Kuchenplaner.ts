class Kuchenplaner {
    ...
    private createDummyEmployees(){
        ...
        employee = new Employee('Peter', 4,3);
        //employee.addShiftList(this.createDummysShift());
        this.employees.addEmployee(employee);
        employee = new Employee('Peter', 2,3);
        //employee.addShiftList(this.createDummysShift());
        this.employees.addEmployee(employee);
        employee = new Employee('Peter', 3,3);
        //employee.addShiftList(this.createDummysShift());
        this.employees.addEmployee(employee);
    ...
    private createDummysShift(shiftList) {
        let shift = new Shift('Motatag', '0');
        shiftList.addShift(shift);
        shift = new Shift('Dienstag', '0');
        shiftList.addShift(shift);
        shift = new Shift('Mittwoch', '0');
        shiftList.addShift(shift);
        shift = new Shift('Donnerstag', '0');
        shiftList.addShift(shift);
        shift = new Shift('Freitag', '0');
        shiftList.addShift(shift);
    }
}
